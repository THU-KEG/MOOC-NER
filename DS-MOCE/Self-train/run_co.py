...
def train(args, train_dataset, tokenizer, labels, pad_token_label_id):
    ...
    for epoch in train_iterator:
        ...
        for step, batch in enumerate(epoch_iterator):
            ...
            inputs1 = {"input_ids": batch[0], "attention_mask": batch[1],"token_type_ids":batch[2],'field_embeds':batch[4], "labels": {"pseudo": pred_labels1}, "label_mask": label_mask1}
            outputs1 = model_s1(**inputs1)

            inputs2 = {"input_ids": batch[0], "attention_mask": batch[1],"token_type_ids":batch[2],'field_embeds':batch[4], "labels": {"pseudo": pred_labels2}, "label_mask": label_mask2}
