...
def config():
    ...
    parser.add_argument('--fields_size', type = int, default = 20, help = 'all fields size')
    parser.add_argument('--embeds_file_path', type = str, default = None, help = 'embedding file')
    ...
    parser.add_argument('--pu_begin_epoch', type=int, default=0, help='begin epoch of pu learning (default 0)')
    parser.add_argument('--prior', type=float, default=0.1, help='estimate value of prior')
    parser.add_argument("--pu_learning", action="store_true", help="Whether to run pu learning.")
    parser.add_argument('--pu_beta', type=float, default=1.0, help='ratio of pu learning (default 0.0)')
    parser.add_argument('--pu_updatefreq', type=int, default=1, help='update freq')
